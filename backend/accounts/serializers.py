...
class AccountDetailsSerializer(serializers.ModelSerializer):
    ...
    newlywedsTableId = serializers.IntegerField(source='newlyweds_table_id')
    budgetLimit = serializers.DecimalField(source='budget_limit', max_digits=10, decimal_places=2)
